...
func (sched *myScheduler) Init(requestArgs RequestArgs, dataArgs DataArgs, moduleArgs ModuleArgs) (err error) {
	...
	oldStatus, err = sched.checkAndSetStatus(SCHED_STATUS_INITIALIZED)
	if err != nil {
		return
	}
	defer func() {
		...
		if err != nil {
			...
			sched.status = SCHED_STATUS_INITIALIZING
		}
	...
	logger.Infof("Data arguments are valid.")
	logger.Infof("Check module arguments...")
...
func (sched *myScheduler) Start(firstHTTPReq *http.Request) (err error) {
	...
	defer func() {
		...
		if err != nil {
			...
			sched.status = SCHED_STATUS_STARTING
		}
		sched.statusLock.Unlock()
	}()
	if err != nil {
...
func (m myScheduler) Stop() (err error) {
	//TODO implement me
	panic("implement me")
}

func (m myScheduler) Status() Status {
	//TODO implement me
	panic("implement me")
}
...
func (m myScheduler) Summary() SchedSummary {
	//TODO implement me
	panic("implement me")
}
