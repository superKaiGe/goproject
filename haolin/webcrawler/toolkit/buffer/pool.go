...
func (m *myPool) BufferCap() uint32 {
	//TODO implement me
	//panic("implement me")
	return m.bufferCap
}

func (m *myPool) MaxBufferNumber() uint32 {
	//TODO implement me
	//panic("implement me")
	return m.maxBufferNumber

}

func (m *myPool) BufferNumber() uint32 {
	//TODO implement me
	//panic("implement me")
	//return m.bufferNumber
	return atomic.LoadUint32(&m.bufferNumber)
}

func (m *myPool) Total() uint64 {
	//TODO implement me
	//panic("implement me")
	return atomic.LoadUint64(&m.total)
}

func (m *myPool) Put(datum interface{}) (err error) {
	//TODO implement me
	//panic("implement me")
	if m.Closed() {
	...
	var count uint32
	maxCount := m.BufferNumber() * 5
	var ok bool
	for buf := range m.bufCh {
		ok, err = m.putData(buf, datum, &count, maxCount)
		if ok || err != nil {
			break
		}
	}
...
func (pool *myPool) putData(buf Buffer, datnum interface{}, count *uint32, maxCount uint32) (ok bool, err error) {
	if pool.Closed() {
